...
function HCard() {
  ...
  return (
    <div className="h-card" style={{ display: "none" }}>
      ...
      <a className="p-org h-card" href={meta.company.url}>
        {meta.company.name}
      </a>
      <a className="u-email h-card" href={`mailto:${meta.social.email}`}>
        {meta.social.email}
      </a>
      <img
        className="u-photo"
        src="https://joshghent.com/images/avatar.jpg"
        alt="avatar"
      />
      <p className="p-note">
        Freelance software engineer with over 8 years experience - specializing
        in web performance and robust infrastructure. Love hiking with my wife
        and dog (Millie). Urban design enthusiest.
      </p>
      ...
      <a href={`https://twitter.com/${meta.social.twitter}`}>
        @{meta.social.twitter} on Twitter
      </a>

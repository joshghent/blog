  ...
  render() {
    ...
    return (
      <Layout location={location} title={siteTitle}>
        <SEO
          title="Josh Ghent"
          keywords={['blog', 'gatsby', 'javascript', 'react', 'josh', 'ghent', 'josh ghent', 'leicesterjs', 'turboapi', 'aws consultancy', 'software resiliency', 'software consultancy']}
        />
          ...
          <section className="cta" style={{ padding: `${rhythm(1.5)} ${rhythm(3)}` }}>
            <div className="row">
              ...
              <div className="right mailbox">
                <p className="bold">I can help cut your cloud costs and save your developers time</p>
